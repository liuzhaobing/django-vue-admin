...
export function getWorkflowList(query) {
  return request({
    url: '/abp/manager/api/wf/workflow/',
    method: 'get',
    params: query
  })
}
...
export function updateWorkflow(id, data) {
  return request({
    url: `/abp/manager/api/wf/workflow/${id}/`,
    method: 'put',
    data
  })
}
...
export function getWfStateList(id) {
  return request({
    url: `/abp/manager/api/wf/workflow/${id}/states`,
    method: 'get'
  })
}
// 工单流转step
export function getWfFlowSteps(id) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/flowsteps/`,
    method: 'get'
  })
}
...
export function ticketHandle(id, data) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/handle/`,
    method: 'post',
    data
  })
}
...
export function updateWfState(id, data) {
  return request({
    url: `/abp/manager/api/wf/state/${id}/`,
    method: 'put',
    data
  })
}
...
export function getWfCustomfieldList(id) {
  return request({
    url: `/abp/manager/api/wf/workflow/${id}/customfields`,
    method: 'get'
  })
}
// 自定义字段创建
export function createWfCustomfield(data) {
  return request({
    url: '/abp/manager/api/wf/customfield/',
    method: 'post',
    data
  })
}
...
export function updateWfCustomfield(id, data) {
  return request({
    url: `/abp/manager/api/wf/customfield/${id}/`,
    method: 'put',
    data
  })
}
...
export function getWfTransitionList(id) {
  return request({
    url: `/abp/manager/api/wf/workflow/${id}/transitions/`,
    method: 'get'
  })
}
// 流转创建
export function createWfTransition(data) {
  return request({
    url: '/abp/manager/api/wf/transition/',
    method: 'post',
    data
  })
}
...
export function updateWfTransition(id, data) {
  return request({
    url: `/abp/manager/api/wf/transition/${id}/`,
    method: 'put',
    data
  })
}
...
export function ticketread(id) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/`,
    method: 'get'
...
export function ticketAccpet(id, data) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/accpet/`,
    method: 'post',
    data
  })
}
...
export function ticketRetreat(id, data) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/retreat/`,
    method: 'post',
    data
  })
}
...
export function ticketAddNode(id, data) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/add_node/`,
    method: 'post',
    data
  })
}
...
export function ticketClose(id, data) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/close/`,
    method: 'post',
    data
  })
}
...
export function ticketAddNodeEnd(id, data) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/add_node_end/`,
    method: 'post',
    data
  })
}
...
export function ticketDestory(data) {
  return request({
    url: `/abp/manager/api/wf/ticket/destory/`,
    method: 'post',
    data
  })
}
...
export function getTicketTransitions(id) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/transitions/`,
    method: 'get'
  })
}
...
export function getTicketFlowlog(id) {
  return request({
    url: `/abp/manager/api/wf/ticket/${id}/flowlogs/`,
    method: 'get'
  })
}
// 工单代办数量
export function getCount(data) {
  return request({
    url: `/abp/manager/api/wf/ticket/duty_agg/`,
    method: 'get',
    params: data
  })
}
...
export function getCodes() {
  return request({
    url: `/abp/manager/api/wf/participant_from_code`,
    method: 'get'
  })
}
// 工单详情
export function getWorkflowInit(id) {
  return request({
    url: `/abp/manager/api/wf/workflow/${id}/init/`,
    method: 'get'
  })
}
