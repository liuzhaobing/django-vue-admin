    ...
    >
      ...
      >
        ...
        <el-form-item label="展示标签" prop="field_type">
          <el-select v-model="customfield.field_type" style="width: 100%" placeholder="请选择">
            <el-option
        ...
        <el-form-item v-show="customfield.field_type=='select'||customfield.field_type=='selects'" label="字段标签">
          <el-input v-model="customfield.label" placeholder="选项类型" />
        </el-form-item>
        <el-form-item v-show="customfield.field_type=='select'||customfield.field_type=='selects'" label="选项">
          <el-button style="border: none;" @click.prevent="addDomain">
            ...
            <el-col :span="10">
              <template>
                <el-form-item label="id：">
                  <el-input v-model="choiceOption[$index].id" type="number" auto-complete="off" placeholder="id为整数" />
                </el-form-item>
              </template>
            </el-col>
            <el-col :span="10">
              <template>
                <el-form-item label="name：">
                  <el-input v-model="choiceOption[$index].name" auto-complete="off" />
                </el-form-item>
              </template>

            </el-col>
            <el-col v-if="$index!==0" :span="3" style="text-align: center">
              <i
...
export default {
  ...
  methods: {
    ...
    async confirm(form) {
      const that = this; const choiceArr = []
